...
public class PerspectiveTranslationAction extends PerspectiveAbstractAction{
    public PerspectiveTranslationAction(Fenetre view, Image img, String text, Icon icon, String description, Integer mnemonic) {
